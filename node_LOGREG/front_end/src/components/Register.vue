...
<div class="login" id="login">
	...
	<div class="log-email">
		...
		<input type="repassword" placeholder="RePassword" :class="'log-input' + (password==''?' log-input-empty':'')" v-model="repassword">
		<a href="javascript:;" class="log-btn" @click="registerIn">Register</a>
	</div>
